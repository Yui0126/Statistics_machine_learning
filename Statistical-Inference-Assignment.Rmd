...
a <- c(" ", "sample", "theoretical","difference")
b <- c("Standard deviation", sampsd,theosd,difsd)
c <- c("Standard error", sampse,theose,difse)
sd <- data.frame(a,b,c)
knitr::kable(sd, col.names = NULL, caption = "Comparing theoretical and sample values of Standard Deviation and Standard Error") %>%
  kable_styling(full_width = F, latex_options = "hold_position")
```
